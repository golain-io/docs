---
title: TUI guide
description: Interactive terminal UI navigation and screens in platform-tui.
---
...
→ Full guide: [Edge SQLite sync](/edge/data-sync/overview) · [platform-tui Edge Sync](/edge/data-sync/platform-tui-guide)
