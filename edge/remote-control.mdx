...
<Note>
  This section covers **legacy shell RPC** (allowlisted commands over signed control topics). For typed protobuf/gRPC services on devices, see [Device gRPC RPC](/edge/device-rpc/overview).
</Note>
