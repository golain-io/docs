...
│  modules: shadow, ota, heartbeat, device-grpc, sqlite-repl, …   │
...
<CardGroup cols={2}>
  ...
  <Card title="Device gRPC RPC" icon="code" href="/edge/device-rpc/overview">
    Typed gRPC services on devices — cloud invoke over HTTP.
  </Card>
